          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                The Future of{" "}
                <span className="text-primary block">Community Finance</span>
              </h1>
              <p className="text-xl text-base-content/70 mb-8 leading-relaxed">
                Join blockchain-powered chitty funds that combine traditional
                savings with modern security. Create or join trusted investment
                circles and grow your wealth together.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-base-content/70 max-w-2xl mx-auto">
              Experience the perfect blend of traditional chitty funds with
      ...
      <section className="py-20 bg-base-200">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-base-content/70 max-w-2xl mx-auto">
              Simple steps to start your chitty journey
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {["Create or Join", "Contribute Monthly", "Receive Payouts"].map(
              (title, index) => (
      ...
      <section className="py-20 bg-base-200">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-base-content/70 mb-8 max-w-2xl mx-auto">
            Join thousands of users already building wealth through our secure
            blockchain chitty platform
          </p>
